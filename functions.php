...
function register_post_reviews(){
	...
	register_post_type( 'reviews', [
		'labels' => [
			...
			'name'                     => 'Reviews', // основное название для типа записи, обычно во множественном числе.
			'singular_name'            => 'Review', // название для одной записи этого типа.
			'add_new'                  => 'добавить отзыв', // текст для добавления новой записи, как "добавить новый" у постов в админ-панели.
												// Если нужно использовать перевод названия, вписывайте подобным образом: _x('Add New', 'product');
			'add_new_item'             => 'Добавление отзыв', // текст заголовка у вновь создаваемой записи в админ-панели. Как "Добавить новый пост" у постов.
			'edit_item'                => 'Редактировать отзыв', // текст для редактирования типа записи. По умолчанию: редактировать пост/редактировать страницу.
			'new_item'                 => 'Новый отзыв', // текст новой записи. По умолчанию: "Новый пост"
			'view_item'                => 'Смотреть отзыв', // текст для просмотра записи этого типа. По умолчанию: "Посмотреть пост"/"Посмотреть страницу".
			'search_items'             => 'Искать отзыв', // текст для поиска по этим типам записи. По умолчанию "Найти пост"/"найти страницу".
			'not_found'                => 'Не найдено', // текст, если в результате поиска ничего не было найдено.
												// По умолчанию: "Постов не было найдено"/"Страниц не было найдено".
			'not_found_in_trash'       => 'Не найдено в корзине', // текст, если не было найдено в корзине. По умолчанию "Постов не было найдено в корзине"/"Страниц
											// не было найдено в корзине".
			'menu_name'                => 'Reviews', // Название меню. По умолчанию равен name.
		],
		'public'             => false,
		'show_ui'            => true,
		'menu_icon'            => 'dashicons-format-chat',
